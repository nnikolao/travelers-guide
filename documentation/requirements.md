...
** περιγραφή**
Το σύστημα μπορεί να συλλέγει πληροφορίες για τις τοποθεσίες που ο χρήστης έχει επισκευθεί στην εφαρμογή και να τον πληροφορεί για τυχών προσφορές στις τοποθεσίες αυτές.
...
**περιγραφή**
Για την καλύτερη εξυπηρέτηση των χρηστών και των επαγγελαμτιών, αλλά και για την εξάπλωση της εφαρμογής, η εφαρμογή θα πρέπει
