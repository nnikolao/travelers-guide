...
**User Priority: (3/5)** Είναι αρκετά σημαντικό ο Επαγγελματίας να έχει αυτή τη δυνατότητα για να μπορεί να κάνει τις κατάλληλες ενέργειες στο σημείο ενδιαφέροντος του.
...
Ο επαγγελματίας πρέπει να μπορεί να ενημερωθεί για τα στοιχεία του Χρήστη που θέλει να κάνει μια κράτηση στο σημείο ενδιαφέροντος του. Κατόπιν να επιβεβαιώσει ή όχι την κράτηση.
...
Οι Χρήστες πρέπει να μπορούν να επικοινωνήσουν μεταξύ τους, με εντός της εφαρμογής προσωπικά μηνύματα.
...
Ο διαχειριστής πρέπει να μπορεί να ενημερωθεί για τυχόν αναληθή κράτηση κάποιου Χρήστη και την επιβολή κάποιας "τιμωρίας" προς τον Χρήστη
...
**User Priority: (4/5)** Η συγκεκριμένη απαίτηση προσδίδει μεγάλη χρησιμότητα στην παρεχόμενη υπηρεσία καθώς προσφέρει πληροφορίες για το συγκεκριμένο σημείο ενδιαφέροντος.
...
**User Priority: (5/5)** Είναι σημαντικό ο Χρήστης να μπορεί να αλλάξει τα στοιχεία του και κυρίως το password, για να είναι πιο ενημερωμένο το σύστημα και την αποφυγή κλοπής του λογαριασμού του.
...
Ο επισκέπτης πρέπει να μπορεί να κάνει αναζήτησεις όπως και οι άλλοι χρήστες, όμως δεν μπορεί να δει λίστες σημείων ενδιαφέροντος, σχόλια και αξιολογήσεις των σημείων αυτών.  
...
Μετά και την παύση κυκλοφορίας του InternetExplorer, οι τρεις παραπάνω browsers κατέχουν τη μερίδα του λέοντος στις προτιμήσεις 
...
Το σύστημα μπορεί να συλλέγει πληροφορίες για τις τοποθεσίες που ο χρήστης έχει επισκεfθεί στην εφαρμογή και να τον πληροφορεί 
...
Ο Χρήστης θα πρέπει να ενημερώνετε οτι κατα την κράτηση του, ο Επαγγελματίας θα έχει πρόσβαση στα στοιχεία του.
...
Ο χρόνος απόκρισης της εφαρμογής κατα την κράτηση δεν θα πρέπει να υπερβαίνει τα 5 δευτερόλεπτα.
...
Για την καλύτερη εξυπηρέτηση και πληροφόρηση του χρήστη, πρέπει να δίνεται η επιλογή αυτή, ούτως ώστε να ξέρει ανα πάσα στιγμή
σε ποιο στάδιο βρίσκεται η κράτησή του.

### ΜΛΑ-9    

Το σύστημα θα πρέπει να μπορεί να υποστηρίξει πολλές φυσικές γλώσσες.

**περιγραφή**

Για την καλύτερη εξυπηρέτηση των χρηστών αλλά και για την εξάπλωση της εφαρμογής, η εφαρμογή θα πρέπει
να υποστηρίζει και άλλες φυσικές γλώσσες εκτός της Αγγλικής και της Ελληνικής.
